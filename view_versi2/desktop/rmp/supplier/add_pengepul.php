	...
	<div class="col-lg-12 col-md-12">
		<div class="list-group">
			<div class="list-group-item">
				<div class="row">
					<div class="col-md-8">
						<h3><i class="fa fa-id-card-o"></i> Tambah Pengepul</h3>
						<hr>
					</div>
					<div class="col-md-4 text-right"></div>
				</div><!--/.row-->
				<form class="formPengepul" id="formPengepul" action="javascript:download();">
				<div class="row">
					<div class="col-md-4">
				...
				<div class="row">
					<div class="col-md-12 text-right">
						<a class="btn btn-success simpanPengepul" id="simpanPengepul">Simpan</a>
					</div>
				</div>
				</form>
			</div>
...
$('.simpanPengepul').on('click',function(){
var formPengepul = $('form.formPengepul').serialize();
console.log(formPengepul);

$.ajax({
	type: 'POST',
	url: refseeAPI,
	dataType: 'json',
	data: 'ref=add_pengepul&' + formPengepul,
	success: function(data) {
		if (data.respon.pesan == "sukses")
		{
			console.log(data.respon.text_msg);
			window.location.href = "?show=rmp/supplier/master_pengepul";
		}
		else if (data.respon.pesan == "gagal")
		{
			console.log(data.respon.text_msg);
