         ...
         <div class="row">
           <div class="col-md-12">
             <div class="form-group">
               ...
               <p class="help-block"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> <i>Anda akan mengganti seluruh penyesuaian harga supplier untuk kelapa Licin.</i></p>
             </div>
           </div>
         </div>
       </form>
...
function supplier_list(curPage)
{
 ...
 $.ajax({
   ...
   url: refseeAPI,
   dataType: 'json',
   data: 'ref=supplier_list_kb&batas=' + $('input#REC_PER_HALAMAN').val() + '&material_id=13&jenis_material=LICIN&halaman=' + curPage + '&keyword=' + $("input#keyword").val() + '&' + filter,
...
$("tbody#zone_data").on('click', '.simpan_harga', function(){
 ...
 var jenis_material = "JENIS_MATERIAL=LICIN"
