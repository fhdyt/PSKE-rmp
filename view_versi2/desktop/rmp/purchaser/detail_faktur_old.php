...
<link rel="stylesheet" href="aplikasi/rmp/asset/select2/dist/css/select2.min.css">
<script src="aplikasi/rmp/asset/select2/dist/js/select2.full.min.js"></script>
<div class="row">
	<div class="col-lg-12 col-md-12">
		<div class="list-group">
			<div class="list-group-item">
				<div class="row">
					<div class="col-md-8">
						<h3><i class="fa fa-list"></i> Purchaser</h3>
						<hr>
					</div>
          ...
          <div class="row">
            <div class="col-md-6">
              <table class="table table-hover">
                ...
                <tr>
                  <td><b>Nama Supplier</b> <small><i>Admin<i></small></td>
                  <td><p class="NAMA_SUPPLIER"><i class="fa fa-spinner fa-pulse fa-fw"></i></p>
                  </td>
                </tr>
                <tr>
                  <td><b>Nama Supplier</b> <small><i>Purchaser<i></small></td>
                  <td><p class="NAMA_SUPPLIER_PURCHASER">
    ...
    success: function(data) {
      if (data.respon.pesan == "sukses") {
        ...
        for (i = 0; i < data.resultb.length; i++) {
          ...
          sel_nama_supplier($("p.NAMA_SUPPLIER").html());
...
function sel_nama_supplier(nama_supplier)
{
  var nama_material = $(".NAMA_MATERIAL").val()
  var grade_material = $(".GRADE_MATERIAL").val()
  // alert(nama_material)
  // alert(grade_material)
  var options =
  {
    ajax: {
      url: refseeAPI,
      ...
      data: {
        ...
        q: '{{{q}}}',
        ref: 'sel_nama_supplier_rek',

      }
    },
    locale:
    {
      emptyTitle: 'Pilih Nama Supplier'
    },
    log: 3,
      ...
      if (l)
      {
        for (i = 0; i < l; i++)
        {
          array.push($.extend(true, data.result[i],
          {
            ...
            {
              subtext: '',
              rekening:data.result[i].RMP_REKENING_RELASI,
              rp:data.result[i].HARGA,
            }
          }));
        }
      }
  ...
  $('select.NAMA_SUPPLIER').on('change', function(){
    ...
    var rekening = $('.NAMA_SUPPLIER option:selected').data('rekening');
  	$('p.NO_REKENING').html(rekening);
    if($('.INPUT_RP_KG').val() == '')
    {
      var rp = $('.NAMA_SUPPLIER option:selected').data('rp');
...
$(".simpanHargaPurchaser").on('click', function(){
  ...
  var form = "" + no_faktur + "&" + personal_id + "&" + id_faktur_purchaser + "&" + rp_kg + "&" + tambang + "&" + biaya + ""
  console.log(form)
  $.ajax({
    type: 'POST',
    url: refseeAPI,
