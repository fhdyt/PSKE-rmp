...
function laporan_faktur_list(curPage)
{
  ...
  $.ajax({
    ...
    url: refseeAPI,
    dataType: 'json',
    data: 'ref=laporan_faktur&batas=' + $('input#REC_PER_HALAMAN').val() + '&halaman=' + curPage + '&keyword=' + $("input#keyword").val()+ '&tanggal=' + $(".FILTER_TANGGAL").val()+ '&material=gelondong',
