    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if (data.respon.pesan == "sukses") {
          ...
          $("td#TOTAL_SUM_BRUTO_C").html(data.result[0].TOTAL_SUM_BRUTO_C)
          $("td#TOTAL_SUM_PERSEN_C").html(data.result[0].TOTAL_SUM_PERSEN_C)
          $("td#TOTAL_SUM_NETTO_C").html(data.result[0].TOTAL_SUM_NETTO_C)
          $("td#TOTAL_SUM_RP_C").html(data.result[0].TOTAL_SUM_RP_C)
          $("td#TOTAL_SUM_RP_KG_C").html(data.result[0].TOTAL_SUM_RP_KG_C)
