		...
		<div class="row">
			<div class="col-md-12">
				...
				switch (strtoupper($d2))
					...
					case 'TAMBAH_FAKTUR_CABANG':
						require_once ("rmp/faktur_cabang/tambah_faktur_cabang.php");
						break;
					case 'REVIEW_FAKTUR_CABANG':
						require_once ("rmp/faktur_cabang/review_faktur_cabang.php");
						break;

					default:
						require_once ("rmp/faktur_cabang/faktur_cabang.php");
						break;
					}
