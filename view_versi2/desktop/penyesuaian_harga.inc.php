		...
		<div class="row">
			<div class="col-md-12">
				...
				switch (strtoupper($d2))
					{
				case 'KOPRA':
					require_once ("rmp/penyesuaian_harga/kopra.php");
					break;
				case 'GELONDONG':
					require_once ("rmp/penyesuaian_harga/gelondong.php");
					break;
				case 'KELAPA_BULAT':
					require_once ("rmp/penyesuaian_harga/kelapa_bulat.php");
					break;
				case 'LICIN':
					require_once ("rmp/penyesuaian_harga/licin.php");
					break;
