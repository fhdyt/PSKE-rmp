			...
			if(data.respon.pesan=="sukses")
			{
				...
				if(JENIS_LAPORAN=="Harian" || JENIS_LAPORAN=="Mingguan" || JENIS_LAPORAN=="Pengaturan" || JENIS_LAPORAN=="Bulanan")
				{
					...
					for (var result = 0; result < data.result.length; result++) 
					{
						...
						tableContent += "<tr class='trBaris'><td class='trBaris' rowspan=" + parseInt(1 + rowspanAPTambahan + rowspanTetapFakturX + rowspan) + ">" + data.result[result].RMP_REKENING_RELASI + "<br>"+ data.result[result].RMP_MASTER_PERSONAL_NAMA +"</td>"+tdFakturKosong+"</tr>";
						var APLength = 0;
						for (var i = 0; i < detailLength; i++) 
						{
							...
							tableContent += "<tr class='trBaris'>"+
								...
								if(JumlahAP>0)
								{
									tableContent += "<tr class='trSumAP'>"+
															"<td class='trSumAP text-right' colspan='2'>Nilai Invoice</td>"+
															"<td class='trSumAP text-right trBold'>"+formatNumber(data.result[result].FAKTUR[i].NilaiFakturs) +"</td>"+
															"<td class='trSumAP text-right'>Jlh AP Pembayaran (<b>"+data.result[result].FAKTUR[i].JumlahAPFaktur+"</b>)</td>"+
															"<td class='trSumAP text-right'>Nilai Bayar</td>"+
															"<td class='trSumAP text-right trBold'>"+formatNumber(data.result[result].FAKTUR[i].NilaiBayarFaktur) +"</td>"+
															"<td class='trSumAP text-right' colspan='2'>Sisa Hutang</td>"+
						...
						if(JumlahFAKTUR>0)
						{
							tableContent += "<tr class='trSumFaktur'>"+
													"<td class='trSumFaktur text-left'><span class='trInfo'>#"+data.result[result].RMP_REKENING_RELASI+"<br>"+data.result[result].RMP_MASTER_PERSONAL_NAMA+"</span><br>Jumlah Invoice (<b>"+data.result[result].JLH_FAKTUR+"</b>)</td>"+
													"<td class='trSumFaktur text-right'>Total Nilai Invoice</td>"+
													...
													"<td class='trSumFaktur text-right' colspan='2'>Sisa Hutang</td>"+
					...
					tableContent += "<tr class='trSumFaktur'>"+
													"<td class='trSumSuplier text-right' colspan='2'>Total Keseluruhan Jumlah Invoice (<b>"+data.resultTotal.TOTAL_KESELURUHAN_JLH_FAKTUR+"</b>)</td>"+
													"<td class='trSumSuplier text-right'>Total Nilai Invoice</td>"+
													"<td class='trSumSuplier text-right trBold'>"+formatNumber(data.resultTotal.TotalKeseluruhanNilaiFaktur)+"</td>"+
													"<td class='trSumSuplier text-right' colspan='2'>Total Nilai Bayar</td>"+
													"<td class='trSumSuplier text-right trBold'>"+formatNumber(data.resultTotal.TotalKeseluruhanNilaiBayarFaktur)+"</td>"+
													"<td class='trSumSuplier text-right' colspan='2'>Sisa Hutang</td>"+
													"<td class='trSumSuplier text-right trBold'>"+formatNumber(data.resultTotal.TotalKeseluruhanSisaHutangFaktur)+"</td>"+
												"</tr>";
