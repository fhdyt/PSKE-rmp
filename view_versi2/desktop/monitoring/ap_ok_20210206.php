				...
				if(JENIS_LAPORAN=="Harian" || JENIS_LAPORAN=="Mingguan" || JENIS_LAPORAN=="Pengaturan" || JENIS_LAPORAN=="Bulanan")
				{
					...
					for (var result = 0; result < data.result.length; result++) 
					{
						...
						for (var i = 0; i < detailLength; i++) 
						{
							...
							//kebutuhan rowspan tambahan ketika faktur ada
							var JumlahRowAP=data.result[result].FAKTUR[i].AP.length;
							if(JumlahRowAP>0)
							{
								var rowspanTetapFakturX=1;
							}else{
							...
							tableContent += "<tr class='trBaris'>"+
												...
												"</td>"+
												"<td  class='trBaris text-left' rowspan=" + parseInt(1 + APLength) + ">"+
													data.result[result].FAKTUR[i].TglInvoices +
												"</td>"+
												...
												for (var j = 0; j < APLength; j++) 
												{
													tableContent += "<tr class='trBaris'>"+
															...
															"<td class='trBaris text-left'>" + data.result[result].FAKTUR[i].AP[j].Tanggals+ "</td>"+
															"<td class='trBaris text-right'>" + formatNumber(data.result[result].FAKTUR[i].AP[j].IDREquivalents) + "</td>"+
															"<td class='trBaris text-left'>" + data.result[result].FAKTUR[i].AP[j].TglBayars + "</td>"+
