		...
		<div class="row">
			<div class="col-md-12">
				...
				case 'MASTER_SUPPLIER':
					require_once ("rmp/supplier/master_supplier.php");
					break;

				case 'ADD_SUPPLIER':
					require_once ("rmp/supplier/add_supplier.php");
					break;

				case 'MASTER_PENGIRIM':
					require_once ("rmp/supplier/master_pengirim.php");
					break;

				case 'ADD_PENGIRIM':
					require_once ("rmp/supplier/add_pengirim.php");
					break;

					case 'MASTER_PENGEPUL':
						require_once ("rmp/supplier/master_pengepul.php");
						break;

					case 'ADD_PENGEPUL':
						require_once ("rmp/supplier/add_pengepul.php");
						break;

					default:
						require_once ("rmp/supplier/master_relasi.php");
						break;
					}
