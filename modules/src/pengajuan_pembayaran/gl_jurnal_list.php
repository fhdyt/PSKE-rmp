...
if (empty($input['rekening'])) {
	...
	$this->callback['respon']['text_msg'] = "Masukkan Nomor Rekening terlebih dahulu.";
...
foreach ($result_a as $r) {
	$queri_1 = "SELECT RECORD_STATUS AS STATUS_FAKTUR FROM RMP_JURNAL WHERE RMP_JURNAL_NO_FAKTUR LIKE '%" . $r['NoFaktur'] . "%' AND RECORD_STATUS='A'
									";
	$this->MYSQL = new MYSQL();
	$this->MYSQL->database = $this->CONFIG->mysql_koneksi()->db_nama;
