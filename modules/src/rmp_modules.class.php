	...
	private	function module($params)
	{
		...
		switch (strtolower($params['case'])) {
			...
			case 'nonlogin_hapus_rekening':
				...
				break;
			case 'nonlogin_prioritas_rekening':
				require_once("supplier/prioritas_rekening.php");
				break;
			...
			case 'nonlogin_cetak_faktur_adm':
				...
				break;
			case 'nonlogin_cetak_faktur_adm_kp':
				require_once("faktur_kp/cetak_faktur_adm_kp.php");
				break;
			...
			case 'nonlogin_lihat_faktur_kp':
				require_once("faktur_kp/lihat_faktur_kp.php");
				break;
			...
			case 'nonlogin_kirim_hasil_timbang_kp':
				...
				break;
			case 'nonlogin_new_no_faktur_kp':
				require_once("faktur_kp/new_no_faktur_kp.php");
				break;
			...
			case 'nonlogin_laporan_relasi_faktur_kp':
				...
				break;
			case 'nonlogin_total_laporan_relasi':
				require_once("laporan_relasi/total_laporan_relasi.php");
				break;
			...
			case 'nonlogin_kirim_pengajuan_pembayaran':
				...
				break;
			case 'nonlogin_kirim_pengajuan_pembayaran_check':
				require_once("pengajuan_pembayaran/kirim_pengajuan_pembayaran_check.php");
				break;
			case 'nonlogin_jurnal_list':
				require_once("pengajuan_pembayaran/jurnal_list.php");
				break;
			case 'nonlogin_jurnal_list_grup':
				require_once("pengajuan_pembayaran/jurnal_list_grup.php");
				break;
			...
			case 'nonlogin_sel_nama_supplier_rekening':
				...
				break;
			case 'nonlogin_simpan_pembagian_dana':
				require_once("pengajuan_pembayaran/simpan_pembagian_dana.php");
				break;
			case 'nonlogin_simpan_detail_dana':
				require_once("pengajuan_pembayaran/simpan_detail_dana.php");
				break;
			case 'nonlogin_sel_rekening_bank':
				require_once("pengajuan_pembayaran/sel_rekening_bank.php");
				break;
			...
			case 'nonlogin_sel_nama_supplier_ambil_setor':
				require_once("ambil_setor/sel_nama_supplier_ambil_setor.php");
				break;
			case 'nonlogin_list_ambil_setor':
				require_once("ambil_setor/list_ambil_setor.php");
				break;
			case 'nonlogin_kirim_ambil_setor':
				require_once("ambil_setor/kirim_ambil_setor.php");
				break;
			case 'nonlogin_hapus_ambil_setor':
				require_once("ambil_setor/hapus_ambil_setor.php");
				break;

				//monitoring
			case 'nonlogin_monitoring_ap':
				require_once("monitoring/ap.php");
				break;
			case 'nonlogin_monitoring_ap_pengajuan':
