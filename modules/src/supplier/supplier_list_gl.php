...
foreach($result_a as $r)
    {
        ...
        $tanggal = date("Y-m-d");
          $sql9 = "SELECT * FROM
                   ...
                   AND
                   Q.RMP_PENYESUAIAN_HARGA_GL_TANGGAL_BERAKHIR >= '".$tanggal."')
                   OR
                   (Q.RMP_PENYESUAIAN_HARGA_GL_TANGGAL_BERLAKU <= '".$tanggal."'
                   AND
                   Q.RMP_PENYESUAIAN_HARGA_GL_TANGGAL_BERAKHIR = '0000-00-00')
                   AND
                   Q.RECORD_STATUS='A'
                   AND
                   M.RECORD_STATUS='A'";
        ...
        else
        {
          ...
          foreach($result_b9 as $rb9)
          {
            ...
            $r['ID_PENYESUAIAN_HARGA']=$rb9['RMP_PENYESUAIAN_HARGA_GL_ID'];
