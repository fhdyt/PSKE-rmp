...
$sql = "SELECT * FROM RMP_KELUARGA AS A LEFT JOIN RMP_MASTER_PERSONAL AS W ON A.KELUARGA_ID=W.RMP_MASTER_PERSONAL_ID
          LEFT JOIN
          ...
          WHERE
                    A.SUPPLIER_ID='".$input['ID_SUPPLIER']."'
          AND
                    A.RECORD_STATUS='A'
          AND
                    W.RECORD_STATUS='A'
          AND
                    W.RMP_MASTER_PERSONAL_ROLE='KELUARGA'";
