...
$sql = "SELECT * FROM RMP_MASTER_PERSONAL AS P
        ...
        W.RECORD_STATUS='A'
        AND
        (P.RMP_MASTER_PERSONAL_ROLE='PETANI' OR P.RMP_MASTER_PERSONAL_ROLE='PENGEPUL') AND RR.RMP_REKENING_RELASI_MATERIAL='".$input['FILTER_MATERIAL']."' " . $filter_a . " " . $filter_b . " GROUP BY P.RMP_MASTER_PERSONAL_ID";
// $sql = "SELECT * FROM RMP_MASTER_PERSONAL AS P
//         LEFT JOIN RMP_MASTER_WILAYAH AS W ON P.SUB_WILAYAH_ID=W.RMP_MASTER_WILAYAH_ID
//         WHERE
//         P.RECORD_STATUS='A'
