...
$this->MYSQL->queri="select * from RMP_KONFIGURASI_PETUGAS WHERE (RMP_KONFIGURASI_PETUGAS_NAMA LIKE '%".$input['q']."%' OR RMP_KONFIGURASI_PETUGAS_NIK LIKE '%".$input['q']."%') AND RMP_KONFIGURASI_PETUGAS_TIPE='INSPEKTUR MUTU' AND RECORD_STATUS='A'";
