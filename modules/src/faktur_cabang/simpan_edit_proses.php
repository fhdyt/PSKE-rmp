...
if(empty($input['PROSES_ID']))
{
	$data_detail2 = array(
		'RMP_REKAP_FC_PROSES_ID' => waktu_decimal(Date("Y-m-d H:i:s")),
		'RMP_REKAP_FC_ID' => $input['PROSES_ID_FAKTUR_CABANG'],
		'RMP_REKAP_FC_PROSES_NAMA' => $input['PROSES_NAMA'],
		'RMP_REKAP_FC_PROSES_JENIS' => $input['PROSES_JENIS_KB'],
		'RMP_REKAP_FC_PROSES_TANGGAL' => $input['PROSES_TANGGAL'],
