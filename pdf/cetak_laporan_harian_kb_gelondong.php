...
foreach($respon['result_'.$kode] as $r){
	...
	${sum_bruto_c_.$kode} += $r['BRUTO_C'];
	${sum_persen_c_.$kode} = round(((${sum_bruto_c_.$kode}-${sum_netto_c_.$kode})/${sum_bruto_c_.$kode})*100);
	${sum_netto_c_.$kode} += $r['NETTO_C'];
	${sum_rp_kg_c_.$kode} += $r['RP_KG_C'];
	${sum_rp_c_.$kode} += $r['RP_C'];
	${sum_rp_kg_c_.$kode} = ${sum_rp_c_.$kode}/${sum_netto_c_.$kode};
	...
	<td align="right">'.number_format($r['BRUTO_C'],0,",",".").'</td>
	<td align="right">'.number_format($r['PERSEN_C'],0,",",".").'</td>
	<td align="right">'.number_format($r['NETTO_C'],0,",",".").'</td>
	<td align="right">'.number_format($r['RP_KG_C'],0,",",".").'</td>
	<td align="right">'.number_format($r['RP_C'],0,",",".").'</td>
	</tr>
	';
}
}
...
tr {
	...
	<thead>
      ...
      <td colspan="5"><center>KB-C</center></td>
		</tr>
		<tr>
      ...
      <td><center>Rp</center></td>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($sum_persen_a_02,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_persen_b_02,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_bruto_c_02,0,",",".").'</td>
			<td align="right">'.number_format($sum_persen_c_02,0,",",".").'</td>
			<td align="right">'.number_format($sum_netto_c_02,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_kg_c_02,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_c_02,0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($respon['result_bulan_02'][0]['SUM_BRUTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_02'][0]['SUM_PERSEN_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_02'][0]['SUM_NETTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_02'][0]['SUM_RP_KG_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_02'][0]['SUM_RP_C_BULAN'],0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($sum_persen_a_03,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_persen_b_03,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_bruto_c_03,0,",",".").'</td>
			<td align="right">'.number_format($sum_persen_c_03,0,",",".").'</td>
			<td align="right">'.number_format($sum_netto_c_03,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_kg_c_03,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_c_03,0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($respon['result_bulan_03'][0]['SUM_BRUTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_03'][0]['SUM_PERSEN_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_03'][0]['SUM_NETTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_03'][0]['SUM_RP_KG_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_03'][0]['SUM_RP_C_BULAN'],0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($sum_persen_a_04,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_persen_b_04,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_bruto_c_04,0,",",".").'</td>
			<td align="right">'.number_format($sum_persen_c_04,0,",",".").'</td>
			<td align="right">'.number_format($sum_netto_c_04,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_kg_c_04,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_c_04,0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($respon['result_bulan_04'][0]['SUM_BRUTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_04'][0]['SUM_PERSEN_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_04'][0]['SUM_NETTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_04'][0]['SUM_RP_KG_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_04'][0]['SUM_RP_C_BULAN'],0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($sum_persen_a_05,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_persen_b_05,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_bruto_c_05,0,",",".").'</td>
			<td align="right">'.number_format($sum_persen_c_05,0,",",".").'</td>
			<td align="right">'.number_format($sum_netto_c_05,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_kg_c_05,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_c_05,0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($respon['result_bulan_05'][0]['SUM_BRUTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_05'][0]['SUM_PERSEN_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_05'][0]['SUM_NETTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_05'][0]['SUM_RP_KG_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_05'][0]['SUM_RP_C_BULAN'],0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($sum_persen_a_06,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_persen_b_06,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_bruto_c_06,0,",",".").'</td>
			<td align="right">'.number_format($sum_persen_c_06,0,",",".").'</td>
			<td align="right">'.number_format($sum_netto_c_06,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_kg_c_06,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_c_06,0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($respon['result_bulan_06'][0]['SUM_BRUTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_06'][0]['SUM_PERSEN_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_06'][0]['SUM_NETTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_06'][0]['SUM_RP_KG_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_06'][0]['SUM_RP_C_BULAN'],0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($sum_persen_a_07,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_persen_b_07,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_bruto_c_07,0,",",".").'</td>
			<td align="right">'.number_format($sum_persen_c_07,0,",",".").'</td>
			<td align="right">'.number_format($sum_netto_c_07,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_kg_c_07,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_c_07,0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($respon['result_bulan_07'][0]['SUM_BRUTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_07'][0]['SUM_PERSEN_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_07'][0]['SUM_NETTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_07'][0]['SUM_RP_KG_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_07'][0]['SUM_RP_C_BULAN'],0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($sum_persen_a_08,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_persen_b_08,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_bruto_c_08,0,",",".").'</td>
			<td align="right">'.number_format($sum_persen_c_08,0,",",".").'</td>
			<td align="right">'.number_format($sum_netto_c_08,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_kg_c_08,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_c_08,0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($respon['result_bulan_08'][0]['SUM_BRUTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_08'][0]['SUM_PERSEN_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_08'][0]['SUM_NETTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_08'][0]['SUM_RP_KG_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_08'][0]['SUM_RP_C_BULAN'],0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($sum_persen_a_09,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_persen_b_09,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_bruto_c_09,0,",",".").'</td>
			<td align="right">'.number_format($sum_persen_c_09,0,",",".").'</td>
			<td align="right">'.number_format($sum_netto_c_09,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_kg_c_09,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_c_09,0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($respon['result_bulan_09'][0]['SUM_BRUTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_09'][0]['SUM_PERSEN_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_09'][0]['SUM_NETTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_09'][0]['SUM_RP_KG_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_09'][0]['SUM_RP_C_BULAN'],0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($sum_persen_a_10,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_persen_b_10,0,",",".").'</td>
			...
			<td align="right">'.number_format($sum_bruto_c_10,0,",",".").'</td>
			<td align="right">'.number_format($sum_persen_c_10,0,",",".").'</td>
			<td align="right">'.number_format($sum_netto_c_10,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_kg_c_10,0,",",".").'</td>
			<td align="right">'.number_format($sum_rp_c_10,0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#FFFF00">
			...
			<td align="right">'.number_format($respon['result_bulan_10'][0]['SUM_BRUTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_10'][0]['SUM_PERSEN_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_10'][0]['SUM_NETTO_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_10'][0]['SUM_RP_KG_C_BULAN'],0,",",".").'</td>
			<td align="right">'.number_format($respon['result_bulan_10'][0]['SUM_RP_C_BULAN'],0,",",".").'</td>
		</tr>
		...
		<tr style="background-color:#7CFC00">
			...
			<td align="right">'.number_format($respon['total'][0]['TOTAL_SUM_BRUTO_C'],0,",",".").'</td>
			<td align="right">'.round((($respon['total'][0]['TOTAL_SUM_BRUTO_C']-$respon['total'][0]['TOTAL_SUM_NETTO_C'])/$respon['total'][0]['TOTAL_SUM_BRUTO_C'])*100).'</td>
			<td align="right">'.number_format($respon['total'][0]['TOTAL_SUM_NETTO_C'],0,",",".").'</td>
			<td align="right">'.number_format(($respon['total'][0]['TOTAL_SUM_RP_C']/$respon['total'][0]['TOTAL_SUM_NETTO_C']),0,",",".").'</td>
			<td align="right">'.number_format($respon['total'][0]['TOTAL_SUM_RP_C'],0,",",".").'</td>
		</tr>
		<tr style="background-color:#7CFC00">
			...
			<td align="right">'.number_format($respon['total'][0]['TOTAL_BULAN_SUM_BRUTO_C'],0,",",".").'</td>
			<td align="right">'.round((($respon['total'][0]['TOTAL_BULAN_SUM_BRUTO_C']-$respon['total'][0]['TOTAL_BULAN_SUM_NETTO_C'])/$respon['total'][0]['TOTAL_BULAN_SUM_BRUTO_C'])*100).'</td>
			<td align="right">'.number_format($respon['total'][0]['TOTAL_BULAN_SUM_NETTO_C'],0,",",".").'</td>
			<td align="right">'.number_format(($respon['total'][0]['TOTAL_BULAN_SUM_RP_C']/$respon['total'][0]['TOTAL_BULAN_SUM_NETTO_C']),0,",",".").'</td>
			<td align="right">'.number_format($respon['total'][0]['TOTAL_BULAN_SUM_RP_C'],0,",",".").'</td>
		</tr>
		</tr>
	</table>
	</body>
