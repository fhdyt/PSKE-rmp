...
{
	$checkbox_langsung_proses = 'checked.png';
}
else
{
	$checkbox_langsung_proses = 'check.png';
}

if($kotoran == 'Y')
{
	$checkbox_kotoran = 'checked.png';
}
else
{
	$checkbox_kotoran = 'check.png';
}
...
foreach($respon['result'] as $r){
	...
	<td>
	'.number_format($r['RMP_FAKTUR_DETAIL_NETTO'],0,",",".").' Kg
	</td>
...
tr {
	...
	<table>
		...
		<tr>
		<td><img src="aplikasi/rmp/asset/'.$checkbox_kotoran.'" width="10" /> Kotoran KG/Goni</td>
		</tr>
		<tr>
		<td><img src="aplikasi/rmp/asset/'.$check_inspeksi.'" width="10" /> 100 % Inspeksi</td>
		</tr>
		<tr>
		<td><img src="aplikasi/rmp/asset/'.$checkbox_langsung_proses.'" width="10" /> Langsung Proses</td>
		</tr>
		<tr>
	...
	<table class="table2">
		...
		<tr>
			...
			<td><img width="50" height="54" src="asset/platform/files/ttd/'.$adm.'.png"><br><br>'.$admnama.'<hr>ADM RMPr-KP</td>
