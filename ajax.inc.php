...
switch ($ref) {
	...
	case 'hapus_rekening':
		...
		break;
	case 'prioritas_rekening':
		require_once("ajax/supplier/prioritas_rekening.php");
		break;
	case 'hapus_wilayah':
	...
	case 'laporan_relasi_faktur_kp':
		...
		break;
	case 'total_laporan_relasi':
		require_once("ajax/laporan_relasi/total_laporan_relasi.php");
		break;
	...
	case 'kirim_pengajuan_pembayaran':
		...
		break;
	case 'kirim_pengajuan_pembayaran_check':
		require_once("ajax/pengajuan_pembayaran/kirim_pengajuan_pembayaran_check.php");
		break;
	case 'jurnal_list':
		require_once("ajax/pengajuan_pembayaran/jurnal_list.php");
		break;
	case 'jurnal_list_grup':
		require_once("ajax/pengajuan_pembayaran/jurnal_list_grup.php");
		break;
	...
	case 'sel_nama_supplier_rekening':
		...
		break;
	case 'simpan_pembagian_dana':
		require_once("ajax/pengajuan_pembayaran/simpan_pembagian_dana.php");
		break;
	case 'simpan_detail_dana':
		require_once("ajax/pengajuan_pembayaran/simpan_detail_dana.php");
		break;
	case 'sel_rekening_bank':
		require_once("ajax/pengajuan_pembayaran/sel_rekening_bank.php");
		break;
	...
	case 'sel_nama_supplier_ambil_setor':
		require_once("ajax/ambil_setor/sel_nama_supplier_ambil_setor.php");
		break;
	case 'list_ambil_setor':
		require_once("ajax/ambil_setor/list_ambil_setor.php");
		break;
	case 'kirim_ambil_setor':
		require_once("ajax/ambil_setor/kirim_ambil_setor.php");
		break;
	case 'hapus_ambil_setor':
		require_once("ajax/ambil_setor/hapus_ambil_setor.php");
		break;
		...
		//monitoring
	case 'monitoring_ap':
		require_once("ajax/monitoring/ap.php");
		break;
	case 'monitoring_ap_pengajuan':
		require_once("ajax/monitoring/ap_pengajuan.php");
		break;
